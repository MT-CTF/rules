...
local items = {
	...
	S("        the same players definitely isn't.(Spawnkilling is considered"),
	S("excessive and thus forbidden if it doesn't contribute to the goal of the"),
	S("game in a proper way. Consequently, spawnkilling can already be punished if"),
	S("only two kills are made – depending on the situation)"),
